...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/cipher-*/`. See [department-index.md](../references/department-index.md#cipher) for the routing list.
