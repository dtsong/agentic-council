...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/scout-*/`. See [department-index.md](../references/department-index.md#scout) for the routing list.
