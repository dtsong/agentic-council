...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/prover-*/`. See [department-index.md](../references/department-index.md#prover) for the routing list.
