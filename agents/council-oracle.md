...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/oracle-*/`. See [department-index.md](../references/department-index.md#oracle) for the routing list.
