...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/warden-*/`. See [department-index.md](../references/department-index.md#warden) for the routing list.
