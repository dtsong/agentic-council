...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/guardian-*/`. See [department-index.md](../references/department-index.md#guardian) for the routing list.
