...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/craftsman-*/`. See [department-index.md](../references/department-index.md#craftsman) for the routing list.
