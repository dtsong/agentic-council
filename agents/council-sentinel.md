...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/sentinel-*/`. See [department-index.md](../references/department-index.md#sentinel) for the routing list.
