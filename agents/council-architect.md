...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/architect-*/`. See [department-index.md](../references/department-index.md#architect) for the routing list.
