...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/strategist-*/`. See [department-index.md](../references/department-index.md#strategist) for the routing list.
