...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/pathfinder-*/`. See [department-index.md](../references/department-index.md#pathfinder) for the routing list.
