...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/artisan-*/`. See [department-index.md](../references/department-index.md#artisan) for the routing list.
