...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/chronicler-*/`. See [department-index.md](../references/department-index.md#chronicler) for the routing list.
