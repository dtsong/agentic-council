...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/alchemist-*/`. See [department-index.md](../references/department-index.md#alchemist) for the routing list.
