...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/herald-*/`. See [department-index.md](../references/department-index.md#herald) for the routing list.
