...
Your skills are bundled in the plugin under `${CLAUDE_PLUGIN_ROOT}/skills/operator-*/`. See [department-index.md](../references/department-index.md#operator) for the routing list.
